!function(a) {
    ...
    var b, c = "function" == typeof define && define.amd, d = function(b) {
        ...
        options: {
            ...
            fontNames: ["Didact Gothic","Arial", "Arial Black", "Comic Sans MS", "Courier New", "Helvetica Neue", "Helvetica", "Impact", "Lucida Grande", "Tahoma", "Times New Roman", "Verdana"],
    ...
    var B = function(a) {
      ...
      , I = function() {
        var b = function(a, b) {
          ...
          , s = function(a) {
            return a.replace(/вЊ/g, "Ctrl").replace(/в‡§/g, "Shift")
        }
          , t = {
            image: function(a, b) {
                var c = "";
            ...
            help: function(a, b) {
                var c = '<a class="modal-close pull-right" aria-hidden="true" tabindex="-1">' + a.shortcut.close + '</a><div class="title">' + a.shortcut.shortcuts + "</div>" + (e.isMac ? r(a, b) : s(r(a, b))) + '<p class="text-center"><a href="//summernote.org/" target="_blank">Summernote 0.6.6</a> В· <a href="//github.com/summernote/summernote" target="_blank">Project</a> В· <a href="//github.com/summernote/summernote/issues" target="_blank">Issues</a></p>';
          ...
          , w = function(a) {
            return e.isMac && (a = a.replace("CMD", "вЊ").replace("SHIFT", "в‡§")),
